...
import colourThemes from "../../../sudoku-game/src/config/colour-themes.json" assert { type: "json" };
import fontThemes from "../../../sudoku-game/src/config/font-themes.json" assert { type: "json" };
import iconSets from "../../../sudoku-game/src/config/icon-sets.json" assert { type: "json" };

/**
 * Login reward tier configuration.
 * Edit this file to adjust daily gem rewards without touching business logic.
 *
 * Each tier has:
 *   daysInTier — how many consecutive login days this tier covers (use Infinity for the final tier)
 *   gems       — gems awarded per day while in this tier
 *   label      — human-readable label shown in the UI
 */
export interface LoginRewardTier {
  label: string;
  daysInTier: number; // Infinity for the last/open-ended tier
  gems: number;
}
